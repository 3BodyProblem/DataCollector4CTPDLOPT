...
//		tagSnapHF.Amount = pQuotationData->Turnover * refNameTable.ContractMult;
	...
	{	///< 更新日期+时间
		...
		QuoCollector::GetCollector()->OnData( 130, (char*)&tagStatus, sizeof(tagStatus), true );
	}

	QuoCollector::GetCollector()->OnData( 132, (char*)&tagSnapLF, sizeof(tagSnapLF), true );
	QuoCollector::GetCollector()->OnData( 133, (char*)&tagSnapHF, sizeof(tagSnapHF), true );
	QuoCollector::GetCollector()->OnData( 134, (char*)&tagSnapBS, sizeof(tagSnapBS), true );
}
